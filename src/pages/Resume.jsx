  ...
  return (
    <div>
      ...
      <div className="position-relative">
        <h3 className="bg-primary bg-opacity-50 w-50 text-center position-absolute start-50 m-2 translate-middle">
          Experience
        </h3>
      </div>
      <Container>
        <Row className="m-5">
          <div className="position-relative">
            <div className="card text-center m-2 overflow-auto position-absolute" style={{ width: 30 + 'rem', height: 300 + 'px' }}>
          ...
          <div className="position-relative">
          <div className="card text-center m-2 overflow-auto position-absolute start-50 " style={{ width: 30 + 'rem', height: 300 + 'px' }}>
            <div className="card-body">
              <h4 className="card-title">
        ...
        <Row>
          <h4 className="bg-primary bg-opacity-50 w-50 text-center position-absolute start-50 m-2 translate-middle">
            Skills
          </h4>
          <div className="card text-center m-5" style={{ width: 60 + 'rem' }}>
            <div className="card-body">
